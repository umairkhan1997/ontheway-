...
class SelectYourTour extends React.Component {
...
<View style={{height:55, marginTop: 0 }} >
            <Header style={{ backgroundColor: '#213e4a', }} >
                                     <Left >
                    <TouchableOpacity onPress={()=>navigate('SelectLT')}>
...
<Text style={{fontSize:18,fontWeight:'500',marginLeft:10,color:'#213e4a',marginTop:0,width:'60%'}}>TOUR TO SCUBA DIVING AT CHARNA ISLAND</Text>
</View>
...
<Text style={{fontWeight:'500',color:'#213e4a'}}>Duration : </Text>
<Text>6 Days</Text>
</View>
<View style={{flexDirection:'row',marginTop:0,marginLeft:10}}>
<Text style={{fontWeight:'500',color:'#213e4a'}}>Starting Location : </Text>
<Text>Karachi</Text>
</View>
<View style={{flexDirection:'row',marginTop:0,marginLeft:10}}>
<Text style={{fontWeight:'500',color:'#213e4a'}}>Location Included : </Text>
<Text>Naran , Kagan</Text>
</View>
<View style={{flexDirection:'row',marginTop:0,marginLeft:10}}>
<Text style={{fontWeight:'500',color:'#213e4a'}}>Activities Included : </Text>
