...
class MTChangeCity extends React.Component {
...
<View  style={{flex:1}}>
       ...
       <View style={{marginTop:0}}>
          ...
          <Left >
          <TouchableOpacity onPress={()=>navigate('MakeTripTwo')}>

<Image source={require('../../../image/left-arrow.png')} style={{width:20,height:20}}/>
</TouchableOpacity>
            </Left>
            <View style={{marginLeft:'25%'}}>
    <Text style={{fontSize:20,fontWeight:'500',marginTop:15,color:'white'}}>Select City</Text>
</View>
<Right>
