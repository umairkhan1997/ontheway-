...
class BusCompanies extends React.Component {
...
<View style={{marginTop:0}}>
          ...
          <Left >
          <TouchableOpacity onPress={()=>navigate('BookBus')}>
...
<View style={{width:'32%'}}>
    ...
    {/* HOTEL ARRAY */}
    <TouchableOpacity onPress={()=>navigate('BusCompanyPage')}>

    <Card style={{width:'100%',height:200,flexDirection:'row',justifyContent:'space-between'}}> 
<View style={{width:'50%'}}>
    <Image source={{uri:'https://i0.wp.com/www.sindhpost.com.pk/wp-content/uploads/2019/02/buses.jpg?resize=696%2C348&ssl=1'}} style={{width:'95%',height:190,marginVertical:5,marginHorizontal:5,borderWidth:0.4,borderColor:'gray'}}/>
</View>
<View style={{width:'50%',}}>
  <Text style={{fontSize:14,fontWeight:'500',marginLeft:5,letterSpacing:5,textDecorationLine:'underline'}}>Sada Bahar Coach Service
 </Text>
  {/* STARS  */}
...
{/* RUPESS */}
<View style={{marginTop:5}}>
  <Text>Rent <Text style={{fontSize:16,fontWeight:'500'}}> PKR. 3000 </Text>For Coach</Text>
</View>
{/* TAX RUPESS */}
<View style={{marginTop:5}}>
  <Text>PKR. 500 taxes and charges</Text>
</View>
{/* CANCEllation */}
...
<Card style={{width:'100%',height:200,flexDirection:'row',justifyContent:'space-between'}}> 
<View style={{width:'50%'}}>
    <Image source={{uri:'https://www.brandsynario.com/wp-content/uploads/2018/04/Untitled-2-19.jpg'}} style={{width:'95%',height:190,marginVertical:5,marginHorizontal:5,borderWidth:0.4,borderColor:'gray'}}/>
</View>
<View style={{width:'50%',}}>
  <Text style={{fontSize:14,fontWeight:'500',marginLeft:5,letterSpacing:5,textDecorationLine:'underline'}}>Karachi Coach Service
 </Text>
  {/* STARS  */}
  <View style={{width:'40%',marginTop:5}}>
  <StarRating
